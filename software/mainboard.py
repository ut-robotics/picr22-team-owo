...
class Mainboard():
    def __init__(self, max_speed, logger):
        ...
        self.throwing_angle_data = [{"angle": self.angle_servo_high, "min_r": 0, "max_r": 5000, "forward_slope": 0.196, "forward_constant": 3588, "backward_slope": 0.207, "backward_constant": 3626},]
        # 0.362 3307
